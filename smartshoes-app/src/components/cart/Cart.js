            ...
            <div class="row d-flex justify-content-center">
                <div class="col-lg-10 col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div> <button class="btn btn-sm bg-light border border-dark" onClick={clearAllItem}>EMPTY CART</button> </div>
                        <div class="px-md-0 px-1" id="footer-font"> <b class="pl-md-4">TOTAL<span class="pl-md-4">  ${Math.round(total * 100)/100}</span></b> </div>
